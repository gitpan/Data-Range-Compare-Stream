...
=head1 SYNOPSIS B 
  ...
  # Use a file as our stream iterator source
  use Data::Range::Compare::Stream::Iterator::File;

  # Objects to be compared are loaded from this Class
  use Data::Range::Compare::Stream;
  ...
  while($compare->has_next) {
    ...
    # organize the results in a way we can understand
    my $columns=$relations->get_root_results($result);

    # This array will be used to fill out our printf statement. First element is the common range
    my @row=($result->get_common);

    # Look at data from our original column perspective
    foreach my $id (@{$relations->get_root_ids}) {
      # Consolidate our related columns and fill in the overlaps if any
