...
=item * my $result=new Data::Range::Compare::Stream::Iterator::Consolidate::Result (COMMON_RANGE,START_RANGE,END_RANGE);
...
=item * my $string=$result->to_string;
  ...
  Returns a string based on the following sprintf statemnet
