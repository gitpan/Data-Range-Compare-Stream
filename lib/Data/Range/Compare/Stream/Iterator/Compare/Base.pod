...
Data::Range::Compare::Stream::Iterator::Compare::Asc - Abstract class

=head1 DESCRIPTION

This module provides the base shared hooks for the Comapre Asc class and any future compare classes.
