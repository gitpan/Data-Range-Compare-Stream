...
=item * my $result=$result->get_consolidator_result_by_id($id);
  ...
  $result will be undef if the column did not overlap with the common range
  
    or

  $result will be an object that implements: Data::Range::Compare::Stream::Iterator::Consolidate::Result
